...
// practicing the concepts i learned in the previous files
...
// // 7
// team1 > team2 && console.log(`It is more likely that team 1 will win`);
// team1 < team2 && console.log(`It is more likely that team 2 will win`);
...
for (let [index,name] of game.scored.entries() ){
  console.log(`${name} scored ${index+1}`)
}
//2  
